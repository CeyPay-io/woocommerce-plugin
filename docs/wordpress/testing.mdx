...
When testing with the CeyPay sandbox environment, use the following credentials:

<ResponseField name="Test API Endpoint" type="url">
  `https://sandbox-api.ceypay.io/`
</ResponseField>

<ResponseField name="Test Merchant ID" type="text">
  `289caebb-ed95-465c-a967-68963bdd20de`
</ResponseField>

<Info>
  These credentials are automatically used when you enable Test Mode in the plugin settings. The plugin will connect to the sandbox API instead of the production environment.
</Info>
